...
import MapView, { PROVIDER_GOOGLE } from 'react-native-maps'; // Utilisation avec Google Maps
  ...
  return (
    <View style={styles.container}>
      ...
      <MapView
        ...
        style={styles.map}
        provider={PROVIDER_GOOGLE} // Utilisation de Google Maps
        initialRegion={{
      ...
      <View style={styles.searchContainer}>
        ...
        >
          <Icon name="bars" size={width * 0.06} color="#000" />
        </TouchableOpacity>
        ...
        >
          <Icon name="search" size={width * 0.05} color="#000" />
        </TouchableOpacity>
      </View>
